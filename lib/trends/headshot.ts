...
export const HEADSHOT_FAQ: ReadonlyArray<{ question: string; answer: string }> = [
  ...
  },
  {
    question: 'Is it free?',
    answer:
      'You get 5 free headshots per week after a quick sign-in. Need more? Buy a credit pack. Free-tier downloads include a small watermark; credits remove it.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Your upload is processed to generate your headshot and is never shown publicly. Free-tier results are stored for 30 days; with credits they are kept until you delete them. You can delete your data anytime from settings.',
  },
  {
