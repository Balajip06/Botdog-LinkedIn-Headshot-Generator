/**
 * Per-output USD cost for each Gemini image model.
...
const COST_USD_PER_IMAGE: Record<GeminiModel, number> = {
  'nano-banana': 0.0039, // v1 — fast/cheap
  'nano-banana-pro': 0.024, // Pro — quality default
}

export function costForOutput(model: GeminiModel): number {
  return COST_USD_PER_IMAGE[model]
}
