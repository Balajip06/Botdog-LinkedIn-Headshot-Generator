...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    description:
      'Default, disabled, typed inputs, required-asterisk label, and Select with defaultOpen.',
  ...
  },
  {
    ...
    description:
      'Click a class to toggle it on the sample element. One-shot animations remount each click.',
